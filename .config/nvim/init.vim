...
" Debugger adapters. Run :VimspectorInstall :VimspectorUpdate to
" install/update. Depends on Python
...
" Show actions
nnoremap <silent> <leader>z  :<C-u>CocAction<cr>
" Coc Navigation
nnoremap <silent> <leader>n  :<C-u>CocNext<cr>
nnoremap <silent> <leader>p  :<C-u>CocPrev<cr>
nnoremap <silent> <leader>c  :<C-u>CocListResume<cr>
...
au Filetype rust let termdebugger="rust-gdb"
